...
const gameData = {
    // DATI ESTRATTI DAL MANUALE DEL GUERRIERO
    "Guerriero": {
    ...
    // DATI ESTRATTI DAL MANUALE DEL TRUFFATORE
    "Truffatore": {
  ...
  // DATI ESTRATTI DAL MANUALE DEL SAGGIO
    "Saggio": {
  ...
  // DATI ESTRATTI DAL MANUALE DELLO STREGONE
    "Stregone": {
  ...
  // DATI ESTRATTI DAL MANUALE DEL DRUIDO
    "Druido": {
...
async function runInstallation() {
    ...
    try {
        ...
        console.log("✅ INSTALLAZIONE COMPLETATA! Tutte le classi sono su Firestore.");
    } catch (error) {
